...
$.dialog = {
	...
	alert:function(set){
		...
		$(".dialog").append('<div class="dialog_body"><div class="dialog_top">'+d.title+'</div><div class="dialog_main">'+d.content+'</div><div class="dialog_bottom"><span><div type="button" value="确定" onclick="'+d.callback+'$.dialog.close();">确定</div></span></div></div>');
	},
	/*信息确定*/
